...
from modeling_nezha import BertConfig, BertForPreTraining #ALBertConfig, ALBertForPreTraining
...
def convert_tf_checkpoint_to_pytorch(tf_checkpoint_path, bert_config_file, pytorch_dump_path, is_albert):
    ...
    if is_albert:
        ...
        raise Exception("Sorry, Albert is not supported so far")
    ...
    for name, array in zip(names, arrays):
        name = name.split('/')
        if any(n in ["lamb_v", "lamb_m", "global_step","bad_steps","good_steps","loss_scale"] for n in name):
